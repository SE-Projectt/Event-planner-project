...
public class HallProfitUpdater {
    ...
    public static void updateOrPrintProfits(String hallName) {
        ...
        } catch (FileNotFoundException e) { logger.warning("Profits file not found. A new one will be created.");} catch (IOException e) {  logger.severe("An error occurred while reading the profits file.");  }
